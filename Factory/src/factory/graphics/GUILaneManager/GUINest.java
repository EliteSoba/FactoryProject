...
class GUINest extends GUIAnimatedObject
{
	public GUINest()
	{
		
	}
	public GUINest(int init_x, int init_y, int init_theta, int init_dx, int init_dy, int init_dtheta, int init_imageWidth, int init_imageHeight, String init_imagePath)
	{
