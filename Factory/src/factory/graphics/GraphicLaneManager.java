...
public class GraphicLaneManager{
	...
	public GraphicLaneManager(int laneX,int laneY, int ID, GraphicPanel gp){
		...
		feederPurged = false;
		lane1Jam = false;lane2Jam = false;
		timerCount = 1; vibrationCount = 0; vibrationAmplitudeTop = 2; vibrationAmplitudeBottom = 2;
